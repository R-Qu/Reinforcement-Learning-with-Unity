...
public class ShoppingShae : MonoBehaviour
{

    public string character = "shae";
    public GameObject salesman;
    SellingSalesman salesman_script;
    public NavMeshAgent agent_shae;
    public Animator animator_shae;
    ...
    void Start()
    {
        ...
        agent_shae = this.gameObject.GetComponent<NavMeshAgent>();
        // Get the game object animator
        animator_shae = this.gameObject.GetComponent<Animator>();
    ...
    void FixedUpdate()
    {
        ...
        Debug.Log("shoppingQuest Shae:" + shoppingQuest);
        ...
        if ((shoppingQuest == 0) && (InputX <= 0.0f) && (salesman_script.shoppingStarted < 2))
        {
            ...
            if (salesman_script.shopOccuppied < 2)
            {
                ...
                question_shae = Random.Range(1, 10);
                // Make the agent moves to the sales man
                agent_shae.SetDestination(new Vector3(0.07f, 0.0f, 1.20f));
            }
        ...
        if (((salesman_script.shopOccuppied == 0) || (!shopFree)) && ((Vector3.Distance(transform.position, new Vector3(0.07f, 0.0f, 1.0f)) <= 0.5f) && !salesDone))
        {
            ...
            agent_shae.isStopped = true;
            // Set the animator selection input.
            animator_shae.SetFloat("InputX", InputX);
    ...
    void SalesDone()
    {
        ...
        agent_shae.SetDestination(new Vector3(-6.5f, 0.0f, 33f));
