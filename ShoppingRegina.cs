...
public class ShoppingRegina : MonoBehaviour
{

    public string character = "regina";
    public GameObject salesman;
    SellingSalesman salesman_script;
    public NavMeshAgent agent_regina;
    public Animator animator_regina;
    ...
    void Start()
    {
        ...
        agent_regina = this.gameObject.GetComponent<NavMeshAgent>();
        // Get the game object animator
        animator_regina = this.gameObject.GetComponent<Animator>();
    ...
    void FixedUpdate()
    {
        ...
        Debug.Log("shoppingQuest Regina:" + shoppingQuest);
        ...
        if ((shoppingQuest == 0) && (InputX <= 0.0f) && (salesman_script.shoppingStarted < 2))
        {
            ...
            if (salesman_script.shopOccuppied < 2)
            {
                ...
                question_regina = Random.Range(1, 10);
                // Make the agent moves to the sales man
                agent_regina.SetDestination(new Vector3(0.07f, 0.0f, 1.20f));
            }
        ...
        if (((salesman_script.shopOccuppied == 0) || (!shopFree)) && ((Vector3.Distance(transform.position, new Vector3(0.07f, 0.0f, 1.0f)) <= 0.5f) && !salesDone))
        {
            ...
            agent_regina.isStopped = true;
            // Set the animator selection input.
            animator_regina.SetFloat("InputX", InputX);
    ...
    void SalesDone()
    {
        ...
        agent_regina.SetDestination(new Vector3(37.0f, 0.0f, -22.0f));
